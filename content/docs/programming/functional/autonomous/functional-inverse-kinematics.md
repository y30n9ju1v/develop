...
*관련 글: [액션, 계산, 데이터](/docs/programming/functional/basics/functional-actions-calculations-data/), [함수 컴포지션](/docs/programming/functional/basics/functional-composition/), [함수형 센서 퓨전](/docs/programming/functional/autonomous/autonomous-sensor-fusion/), [함수형 셰이더 파이프라인](/docs/programming/functional/gpu/functional-shader-pipeline/)*
