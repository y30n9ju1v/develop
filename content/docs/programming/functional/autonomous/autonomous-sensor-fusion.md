...
이전 글 [함수 컴포지션](/docs/programming/functional/basics/functional-composition/)과 [추상화 장벽](/docs/programming/functional/basics/functional-abstraction-barrier/)을 먼저 읽으면 더 자연스럽게 이어집니다.
...
*관련 글: [함수 컴포지션](/docs/programming/functional/basics/functional-composition/), [추상화 장벽](/docs/programming/functional/basics/functional-abstraction-barrier/), [자율주행 센서 파이프라인](/docs/programming/functional/autonomous/autonomous-sensor-pipeline/), [자율주행 경로 계획](/docs/programming/functional/autonomous/autonomous-path-planning/), [ROS2 콜백을 함수형으로](/docs/programming/functional/autonomous/autonomous-ros2-functional/)*
