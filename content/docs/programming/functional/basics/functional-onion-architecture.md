...
이 글은 [액션/계산/데이터](/docs/programming/functional/basics/functional-actions-calculations-data/), [계층형 설계](/docs/programming/functional/basics/functional-stratified-design/), [함수형 DI](/docs/programming/functional/basics/functional-dependency-injection/)를 토대로 합니다. 세 글의 원칙들이 하나의 아키텍처로 합쳐지는 지점입니다.
...
중간층 조율 함수를 테스트할 때는 [함수형 DI](/docs/programming/functional/basics/functional-dependency-injection/) 패턴으로 infra를 교체합니다.
...
- [ACD 구분](/docs/programming/functional/basics/functional-actions-calculations-data/)은 코드 한 줄 단위의 원칙
- [계층형 설계](/docs/programming/functional/basics/functional-stratified-design/)는 함수 단위의 원칙
...
*관련 글: [액션/계산/데이터](/docs/programming/functional/basics/functional-actions-calculations-data/), [계층형 설계](/docs/programming/functional/basics/functional-stratified-design/), [함수형 DI](/docs/programming/functional/basics/functional-dependency-injection/), [타임라인 다이어그램](/docs/programming/functional/basics/functional-timeline-diagram/), [ROS2 콜백을 함수형으로](/docs/programming/functional/autonomous/autonomous-ros2-functional/)*
