...
*관련 글: [일급 함수와 클로저](/docs/programming/functional/basics/functional-first-class-functions/), [함수 컴포지션](/docs/programming/functional/basics/functional-composition/), [계층형 설계](/docs/programming/functional/basics/functional-stratified-design/), [타임라인 다이어그램](/docs/programming/functional/basics/functional-timeline-diagram/), [불변 데이터와 구조적 공유](/docs/programming/functional/basics/functional-immutable-data/), [온어니언 아키텍처](/docs/programming/functional/basics/functional-onion-architecture/), [자율주행 센서 파이프라인](/docs/programming/functional/autonomous/autonomous-sensor-pipeline/), [ROS2 콜백을 함수형으로](/docs/programming/functional/autonomous/autonomous-ros2-functional/), [시뮬레이션 회귀 테스트 설계](/docs/programming/functional/autonomous/autonomous-simulation-regression/), [함수형 PID 제어기](/docs/programming/functional/autonomous/autonomous-pid-controller/)*
