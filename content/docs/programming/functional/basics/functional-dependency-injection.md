...
이 글은 [액션/계산/데이터](/docs/programming/functional/basics/functional-actions-calculations-data/) 시리즈와 이어집니다.
...
*관련 글: [액션/계산/데이터](/docs/programming/functional/basics/functional-actions-calculations-data/), [일급 함수와 클로저](/docs/programming/functional/basics/functional-first-class-functions/), [계층형 설계](/docs/programming/functional/basics/functional-stratified-design/), [온어니언 아키텍처](/docs/programming/functional/basics/functional-onion-architecture/), [자율주행 모드 전이를 타입으로 만들기](/docs/programming/functional/autonomous/autonomous-state-machine/), [ROS2 콜백을 함수형으로](/docs/programming/functional/autonomous/autonomous-ros2-functional/), [시뮬레이션 회귀 테스트 설계](/docs/programming/functional/autonomous/autonomous-simulation-regression/)*
