...
이 글은 [계층형 설계](/docs/programming/functional/basics/functional-stratified-design/)와 [온어니언 아키텍처](/docs/programming/functional/basics/functional-onion-architecture/)의 보완입니다. 계층을 어디서 나눌지, 무엇을 함수로 묶을지 결정할 때 쓰는 기준을 다룹니다.
...
[계층형 설계](/docs/programming/functional/basics/functional-stratified-design/) 글에서 함수들을 변경 빈도에 따라 계층으로 나눴습니다. 추상화 장벽은 그 계층 사이의 경계입니다.
...
*관련 글: [계층형 설계](/docs/programming/functional/basics/functional-stratified-design/), [온어니언 아키텍처](/docs/programming/functional/basics/functional-onion-architecture/), [액션/계산/데이터](/docs/programming/functional/basics/functional-actions-calculations-data/), [함수형 센서 퓨전](/docs/programming/functional/autonomous/autonomous-sensor-fusion/)*
