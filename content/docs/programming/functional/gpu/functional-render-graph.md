...
이전 글 [함수형 셰이더 파이프라인](/docs/programming/functional/gpu/functional-shader-pipeline/)을 먼저 읽으면 더 자연스럽게 이어집니다.
...
*관련 글: [액션, 계산, 데이터](/docs/programming/functional/basics/functional-actions-calculations-data/), [함수형 셰이더 파이프라인](/docs/programming/functional/gpu/functional-shader-pipeline/), [함수형 포인트 클라우드 처리](/docs/programming/functional/autonomous/functional-point-cloud/)*
