...
이번 22번째 강의와 강의 슬라이드에서는 위계 정리를 실전 문제에 적용하여 **"현실적인 시간과 공간 내에 푸는 것이 절대 불가능하다"**라고 완전히 입증된 자연스러운 문제와, 현대 컴퓨터 과학 최고의 난제인 P vs NP 문제가 왜 지금까지도 풀리지 않는지 그 수학적 장벽을 밝히는 **오라클 계산**을 공부하겠습니다.
