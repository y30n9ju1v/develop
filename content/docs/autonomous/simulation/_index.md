...
6. **[회귀 테스트를 셀프서비스로: TS+Refine+FastAPI+Argo Workflows 웹 대시보드](regression-test-web-dashboard/)** — 지도·시나리오 선택부터 결과 종합까지, 인프라를 팀 전체가 쓸 수 있는 웹 제품으로 감싸는 아키텍처와 각 도구 선택의 이유를 정리합니다.
