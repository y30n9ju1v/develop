...
11. **[NuRec 입문: 3D Gaussian Splatting으로 주행 로그를 시뮬레이션 환경으로](nurec-neural-reconstruction-for-beginners/)** — NuRec이 3D Gaussian Splatting으로 센서 로그를 재구성하는 원리, novel view synthesis와 Cosmos 기반 Fixer, CARLA 연동 구조를 정리합니다.
