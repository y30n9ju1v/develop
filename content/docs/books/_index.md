...
- **[nand2npu 2권: NPU로 이미지 처리하고 마리오 플레이하기](nand2npu-vision/)** — 1권의 CPU에 MAC 유닛·시스톨릭 어레이·양자화를 얹어 최소 NPU로 확장한 뒤, 이미지 분류 워밍업을 거쳐 마리오를 플레이하는 강화학습 정책망의 추론까지 NPU 위에서 증명·검증하는 책
